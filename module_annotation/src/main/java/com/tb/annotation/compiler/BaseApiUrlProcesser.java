...
@SupportedAnnotationTypes({"com.tb.annotation.annotation.BaseApiUrl"})
public class BaseApiUrlProcesser extends AbstractProcessor {
    ...
    private void generateClass() {
        for (String key : mProxyMap.keySet()) {
            ...
            try {
                sourceFile = mFileUtils.createSourceFile(proxyInfo.getProxyClassFullName(), proxyInfo.getTypeElement());
    ...
    private void collectionInfo(RoundEnvironment roundEnvironment) {
        ...
        for (Element element : elements) {
            ...
            List<ProxyInfo.ClassInfo> classInfoList = proxyInfo.list;
            if (classInfoList == null) {
                classInfoList = new ArrayList<>();
            }
            ProxyInfo.ClassInfo classInfo = new ProxyInfo.ClassInfo();
            classInfo.value = baseApiUrl;
            classInfo.variableElement = variableElement;
